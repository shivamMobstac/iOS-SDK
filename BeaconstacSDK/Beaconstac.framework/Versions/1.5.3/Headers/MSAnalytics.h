...
/**
 * Returns sessionId for the current session
 */
@property (nonatomic, strong) NSUUID *sessionId;

/**
 * Returns sessionId for the current region
 */
@property (nonatomic, strong) NSString *regionSessionID;

/**
 * Get or set session duration for the current session in case of inactivity
 */
@property (nonatomic) NSTimeInterval sessionDuration;
