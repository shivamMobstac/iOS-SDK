 ...
 * You can pass dev token to be used for the call instead of default
 */
+ (void)GET:(NSString*)URLString parameters:(id)params token:(NSString*)token WithCompletionBlock:(void (^)(NSNumber *statusCode, NSDictionary *responseJson, NSError *error))completionBlock;
